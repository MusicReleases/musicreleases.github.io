...
public class DatabaseArtistsControllerOld2(IIndexedDbFactory dbFactory, IDatabaseUpdateControllerOld databaseUpdateController, ISpotifyControllerUser spotifyControllerUser) : IDatabaseArtistsControllerOld2
{
	...
	private async Task<SpotifyUserList<SpotifyArtist, SpotifyUserListUpdateArtists>?> GetArtistsDb(SpotifyReleasesDbOld db)
	{
	...
	// RELEASES
	private SortedSet<SpotifyRelease> GetReleasesDb(string artistId, SpotifyReleasesDbOld db)
	{
	...
	private HashSet<SpotifyArtist> GetReleaseArtists(string releaseId, SpotifyReleasesDbOld db)
	{

...
public class SpotifyLoginStorageController : ISpotifyLoginStorageController
{
	...
	public SpotifyLoginStorageController(ISpotifyControllerUser spotifyControllerUser, ILocalStorageService localStorage)
	{
		...
		_localStorageKeyInfo = GetLocalStorageKey(ServiceType.Spotify, LocalStorageKey.UserInfo);
		_localStorageKeyCredentials = GetLocalStorageKey(ServiceType.Spotify, LocalStorageKey.UserCredentials);
		_localStorageKeyVerifier = GetLocalStorageKey(ServiceType.Spotify, LocalStorageKey.LoginVerifier);
	}

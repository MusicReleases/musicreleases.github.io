...
public class DbSpotifyUserPlaylistServiceOld(IDbSpotifyServiceOld dbService, IDbSpotifyPlaylistServiceOld dbPlaylistService, IDbSpotifyUpdateServiceOld dbUpdateService) : IDbSpotifyUserPlaylistServiceOld
{
	private readonly IndexedDbStore _dbTable = dbService.GetTable(DbStorageTablesSpotify.SpotifyUserPlaylist);

	private readonly IDbSpotifyPlaylistServiceOld _dbPlaylistService = dbPlaylistService;

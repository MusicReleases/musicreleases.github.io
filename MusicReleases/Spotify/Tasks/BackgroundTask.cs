...
public sealed class BackgroundTask
{
	...
	{
		const string apiGetName = "Getting from API";
		const string apiSaveName = "Saving to API";
		...
		{
			BackgroundTaskCategory.GetApi => apiGetName,
			BackgroundTaskCategory.SaveApi => apiSaveName,
			BackgroundTaskCategory.DeleteApi => apiSaveName,

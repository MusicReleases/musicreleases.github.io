...
public class SpotifyPlaylist(string id, string name, string urlApp, string urlWeb, string snapshotId, string ownerId, bool collaborative, int order) : SpotifyIdNameUrlObject(id, name, urlApp, urlWeb), IComparable
{
	...
	public required int Order { get; init; } = order;
